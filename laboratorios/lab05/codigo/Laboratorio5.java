...
public class Laboratorio5 {
   ...
   /**
    * Este metodo recibe un parametro tipo BinaryTree e invoca al metodo dibujarArbolAux.
   ...
   /**
    * Este metodo recibe un parámetro tipo Node, e imprime un árbol.
    */public static void dibujarArbolAux(Node Node)
   {
    ...
    public static void main(String[] args) {
       ...
       //Dibuja el árbol familiar
        ...
        arbolGenealogico.getGrandMothersName("Alicia");
         arbolGenealogico.getGrandMothersName("Yesica");
    }
}